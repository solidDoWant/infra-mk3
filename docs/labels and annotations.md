...
| `endpoints.netpols.home.arpa` | `teleport-bot-client`                  | `true`   | Pod                    | No       | Indicates that the labeled pod runs a tbot sidecar that joins the Teleport cluster.                   |
| `endpoints.netpols.home.arpa` | `temporal-frontend-client`             | `true`   | Pod                    | No       | Indicates that the labeled pod is a JWT-authenticated client of the Temporal public Frontend.         |
